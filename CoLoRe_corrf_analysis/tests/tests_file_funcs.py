...
class TestFileFuncs(unittest.TestCase):
    ...
    def setUp(self):
        self.s1_s4_full = FileFuncs.get_full_path(self.files_path / 's1_s4', rsd=True, rmin=0.1, rmax=200, zmin=0.5, zmax=0.7, nside=2, N_bins=41, rsd2=False)
        self.s1_full = FileFuncs.get_full_path(self.files_path / 's1', rsd=True, rmin=0.1, rmax=200, zmin=0.5, zmax=0.7, nside=2, N_bins=41, rsd2=None)
