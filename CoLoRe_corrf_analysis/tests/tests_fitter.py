...
class TestAuto(unittest.TestCase):
    def setUp(self):
        ...
        self.fitter = Fitter(boxes=boxes, z=0.2, poles=[0,2], 
                theory=self.theory, rsd=True, bias0=3, 
                smooth_factor0=1, smooth_factor_rsd0=1, smooth_factor_cross0=1,
                rmin={0:10, 2:40}, rmax={0:200, 2:200})
...
class TestCross(unittest.TestCase):
    def setUp(self):
        ...
        self.fitter = Fitter(boxes=boxes, z=0.2, poles=[0,2], 
                theory=self.theory, rsd=True, rsd2=False, bias0=3, bias20=3,
                smooth_factor0=1, smooth_factor_rsd0=1, smooth_factor_cross0=1,
                rmin={0:10, 2:40}, rmax={0:200, 2:200})
